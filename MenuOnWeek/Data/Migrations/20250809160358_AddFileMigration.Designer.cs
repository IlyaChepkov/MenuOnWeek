...
namespace MenuOnWeek.Data.Migrations
{
    ...
    [Migration("20250809160358_AddFileMigration")]
    partial class AddFileMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MenuOnWeek.Domain.File", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Domain.Recipe", b =>
                {
                    b.HasOne("MenuOnWeek.Domain.File", null)
                        .WithOne()
                        .HasForeignKey("Domain.Recipe", "FileId");
                });
